      ...
      >
        <div className="masthead-inner">
          <div className="masthead-topbar">
            <div className="masthead-topbar-left">
              ...
              <span className="masthead-topbar-text">{today || 'Wednesday, August 5, 2026'}</span>
            </div>
            <div className="masthead-topbar-right">
          ...
          <div className="masthead-main">
            ...
            <div className="masthead-right">
              <Link href="/chat" className="masthead-nav-btn">
              ...
              <button className="masthead-nav-btn" onClick={() => setShowMetrics(true)}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <path d="M12 20V10"/>
                  <path d="M18 20V4"/>
                  <path d="M6 20v-4"/>
              ...
              <Link href="/admin/login" className="masthead-nav-btn">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                  <circle cx="12" cy="7" r="4"/>
                </svg>
